...
class RegionGroupReader(myio.Reader):

    def __init__(self, **kwargs):
        super(RegionGroupReader, self).__init__(**kwargs)
...
class RegionReader(myio.Reader):

    def __init__(self, **kwargs):
        super(RegionReader, self).__init__(**kwargs)


class RegionWriter(myio.Writer):

    def __init__(self, **kwargs):
        super(RegionWriter, self).__init__(**kwargs)


class RegionGenerator(module.Module):

    def __init__(self, **kwargs):
        super(RegionGenerator, self).__init__(**kwargs)
...
class Breakpoint(myio.Record):
    ...
    def inside_region(self, region, linkage_distance=1000000):  # 1M
